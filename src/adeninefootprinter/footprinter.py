...
def main():
    ...
    predict.add_argument('--bam', type=str, help='[Recommended] BAM file with single-molecule m6A sites',
                         default='')
    predict.add_argument('--bed', type=str, help='[File1,File2,...] (Alternative for BAM file)'
                                                 ' BED file with single-molecule m6A sites',
                         default='')
    ...
    predict.add_argument('-m', '--model', type=str, help='[Optional] Model File',
                         default=os.path.abspath(os.path.join(script_dir, '../asset/SacCer3_EcoGII.model.json'))),
